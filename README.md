...
> **현 기수: 39기** — 2026-08-06 시작
>
> 실제로 동작을 결정하는 값은 Actions Variables의 `COHORT_START_DATE`다. 여기 적힌 것은 사람이 읽으라고 둔 표시이므로, 기수가 바뀌면 **둘 다** 고친다. 절차는 [RUNBOOK](RUNBOOK.md#기수가-바뀌었을-때)에 있다.
